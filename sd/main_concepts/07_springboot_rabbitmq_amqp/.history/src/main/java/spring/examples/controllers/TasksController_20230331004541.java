...
public class TasksController {
	...
	public ResponseEntity<?> create (@RequestBody String task){
        ...
        try {
			...
			log.info ("URL:"+url);
			HttpResponse<String> response = httpManager.PostHttpRequest(url, t.getParameters());
...
// so add 1 to make it inclusive
        ...
        return new ResponseEntity<HttpResponse<String>>("Task stored "+response, HttpStatus.CREATED);
    }
}
